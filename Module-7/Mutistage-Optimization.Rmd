...
```{r prog-hedging-plot, echo=FALSE, fig.cap="Progressive Hedging Iterations", fig.align='left'}
...
```{r PHA-plot-1, eval=FALSE, echo=FALSE, fig.cap="Progressive Hedging Iterations for the 3-stages asset allocation problem, showing the convergence of the first 4 variables.", fig.align='left'}
alpha <- 1:4
