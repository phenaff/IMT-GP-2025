...
\While{$i<i_{\mbox{max}}$ and $! \mbox{converged}$}{
...
The progress of the algorithm is illustrated by the following graph, where the solution is seen to converge towards the extensive form solution $x_A=2.5, x_B=7.5$.
